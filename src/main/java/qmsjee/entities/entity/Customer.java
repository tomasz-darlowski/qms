...
public class Customer extends BaseEntity {
    ...
    private static final long serialVersionUID = 826049828196124519L;
    @NotNull
    @Size(max = 40)
    private String name;
    @Size(min = 3, max = 60)
    ...
    public Customer(String name, String contactPerson, String address, String email, String telephone) {
        this.name = name;
